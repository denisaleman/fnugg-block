 ...
 *
 * @package   Dekode\FnuggWhetherPlugin\Config\Requirements
...
final class Requirements extends Base {
	...
	public function specifications(): array {
		return apply_filters( 'dekode_fnugg_plugin_requirements', [
		...
		foreach (
			[
				...
				[
					...
					'title'   => __( 'Invalid PHP version', 'gutenberg-fnugg-whether-block' ),
					'message' => sprintf( /* translators: %1$1s: required php version, %2$2s: current php version */
						__( 'You must be using PHP %1$1s or greater. You are currently using PHP %2$2s.', 'gutenberg-fnugg-whether-block' ),
				...
				[
					...
					'title'   => __( 'Invalid WordPress version', 'gutenberg-fnugg-whether-block' ),
					'message' => sprintf( /* translators: %1$1s: required wordpress version, %2$2s: current wordpress version */
						__( 'You must be using WordPress %1$1s or greater. You are currently using WordPress %2$2s.', 'gutenberg-fnugg-whether-block' ),
